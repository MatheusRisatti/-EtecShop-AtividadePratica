    ...
    public class AppDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            List<Categoria> categorias = new()
            {
                ...
                new Categoria { Id = 5, Nome = "Eletrodomésticos e Casa" },
            ...
            List<Produto> produtos = new()
            {
                ...
                new Produto
                {
                    ...
                    Descricao = "Conjunto Mesa De Jantar 6 Lugares Milano Amêndoa Com Savana. Conjunto com 6 Cadeiras Milano da Poliman Moveis: nossos modelos de cadeiras são práticos e resistentes.",
                    Preco = 521.10M,
                    Estoque = 4,
                    CategoriaId = 7,
